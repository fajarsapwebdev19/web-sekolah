...
<script>
    ...
    $('.login').click(function() {
        ...
        if(username == "")
        {
            ...
            $("#message-error").fadeTo(3000, 5000).slideUp(1200,function(){$("#message-error").slideUp(600)});
        }else if(password == "")
        {
            $('#message-error').show();
            ...
            $.ajax({
                ...
                success:function(respond)
                {
                    if(respond == "Berhasil")
                    {
                        ...
                        $("#message-succes").fadeTo(3000, 5000).slideUp(1200,function(){$("#message-succes").slideUp(600)});
